...
for (i in c(1:lanes)) {
    ...
    flowcellid <- dbGetQuery(con,paste("SELECT MAX(flowcell_id) from flowcell_list WHERE ",project_id," IN (lane_1_project,lane_2_project,lane_3_project,lane_4_project,lane_5_project,lane_6_project,lane_7_project,lane_8_project)"))[[1]]
