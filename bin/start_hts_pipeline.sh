...
EOF
            ...
            echo "miseq_start.sh $SOURCE_DIR $sample_sheet" | qsub -l walltime=00:10:00,nodes=1:ppn=8,mem=10gb -j oe -o $HTS_PIPELINE_HOME/logs/miseq_start.$PBS_JOBID.log -m bea -M hts@biocluster.ucr.edu
        fi
    fi
done
